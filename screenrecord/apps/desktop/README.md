...
2. Click the **+** button or toggle switch for "ScreenRecord Tracker"
...
```bash
codesign --verify --verbose /Applications/ScreenRecord\ Tracker.app
```

**Display signature information:**
```bash
codesign --display --verbose=4 /Applications/ScreenRecord\ Tracker.app
```

**Check entitlements:**
```bash
codesign --display --entitlements - /Applications/ScreenRecord\ Tracker.app
```
...
```
<InstallFolder>/
├── ScreenRecord Tracker.exe     (Windows)  or  ScreenRecord Tracker.app (macOS)
...
- **Windows:** `%APPDATA%\com.screenrecord.tracker\` (e.g. `C:\Users\<You>\AppData\Roaming\com.screenrecord.tracker\`)
