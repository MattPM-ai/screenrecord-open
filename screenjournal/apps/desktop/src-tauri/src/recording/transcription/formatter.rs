...
mod tests {
    ...
    fn test_format_transcription_segment_with_audio_path() {
        ...
        let audio_path = "/Users/username/.screenjournal/audio/2025-01-15/segment_123.mp4";
        let result = format_transcription_segment(
            &segment,
            "2025-01-27T10:00:00Z",
            "employee",
        ...
        assert!(line.contains("audio_path=\"/Users/username/.screenjournal/audio/2025-01-15/segment_123.mp4\""));
    }
